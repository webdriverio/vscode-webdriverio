...
import { DebugRunner, DebugSessionTerminatedError, WdioExtensionDebugWorker } from '../../src/api/debug.js'
import * as runModule from '../../src/api/run.js'
import * as workerModule from '../../src/api/worker.js'
...
describe('DebugRunner', () => {
    ...
    it('should start worker and run test', async () => {
        ...
        // Run the test
        const result = await debugRunner.run(testItem)
    ...
    it('should throw DebugSessionTerminatedError when debug session terminates during run', async () => {
        ...
        const runPromise = debugRunner.run(testItem)
